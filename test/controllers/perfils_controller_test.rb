...
class PerfilsControllerTest < ActionController::TestCase
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post :create, perfil: { dataNasc: @perfil.dataNasc, foto: @perfil.foto, telefone: @perfil.telefone, usuario: @perfil.usuario }
    end
  ...
  test "should update perfil" do
    patch :update, id: @perfil, perfil: { dataNasc: @perfil.dataNasc, foto: @perfil.foto, telefone: @perfil.telefone, usuario: @perfil.usuario }
    assert_redirected_to perfil_path(assigns(:perfil))
  end
